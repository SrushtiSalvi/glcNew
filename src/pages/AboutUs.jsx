            ...
            <div className=" flex flex-col sm:flex-row m-4 lg:mx-20 lg:my-5 justify-center ">
                <div className="flex flex-col  justify-end sm:m-3 md:m-8">
                    ...
                    <div className="  my-2  text-left sm:text-right font-poppins font-normal  text-xs lg:text-base xl:text-xl space-y-5 ">
                        <p>
                            Government Law College, Mumbai or GLC, as it is
                            popularly known was established in 1855 and has the
                            distinction of being the oldest Law College in Asia,
                            dating even prior to the University of Mumbai.
                        </p>

                        <p>
                            Having humbly begun as evening classes in a borrowed
                            premises, this college that first lit the candle of
                            legal education in India stands tall amongst all its
                            contemporaries.
                        </p>

                        <p>
                            It enjoys a pre-eminent reputation for excellence in
                            the field of legal education with a seemingly
                            endless list of eminent alumni like Dr. B. R.
                            Ambedkar, Lokmanya Tilak, Justice M. C. Chagla, Sir
                            Motilal Setalvad (first Attorney General of India),
                            and several others who have adorned benches of the
                            Supreme Court of India and the Bombay High Court and
                            left their footprints behind for time immemorial.
                        </p>

                        <p>
                            GLC remains strong and resolute in these trying
                            times of competitive and commercialized nature of
                            legal education by holding on to its institutional
                            ethos and due to the strength of its rich heritage
                            and professional character, thus fulfilling its
                            objectives of training not just the finest of the
                            legal practitioners but also by nurturing
                            professionals and thinkers in every sphere of
                            society.
                        </p>
                    </div>
                </div>
            ...
            <div className="flex flex-col lg:flex-row font-poppins bg-primary-dark my-5 p-2 sm:p-8">
                ...
                <div className="sm:flex-1 mr-25 p-2 ">
                    ...
                    <div className=" text-justify text-white sm:p-5  font-light  text-xs sm:text-lg md:text-xl">
                        <p>
                            The Placement Committee of Government Law College,
                            Mumbai, is one of the most important committees of
                            the college, shouldering the responsibility of
                            providing a stepping stone to success to budding
                            lawyers graduating from the college.
                        </p>
                        <p>
                            The committee aims at exhausting all possible
                            opportunities of recruitment with law firms,
                            counsels, LPOs, and corporate houses. It acts as a
                            link between the recruiters and the students,
                            thereby fulfilling the needs of both, and enabling
                            the students to get placements on campus.
                        </p>
                        <p>
                            The members of the Placement Committee strive hard
                            to ensure that maximum students from the college
                            secure internships and jobs, thus providing them
                            with an opportunity to head start their legal
                            careers. For the last many years, the Placement
                            Committee has been implementing the recruitm ent
                            process throughout the year while also organizing
                            two placement weeks in a year. This widening scope
                            of the committee benefits both the students and the
                            potential employers.
                        </p>
                        <p>
                            The increasing rate of students getting recruited by
                            the day is a source of inspiration for all students
                            who work zealously for the committee, and encourages
                            them to undertake the tasks of the committee with
                            even greater zeal and enthusiasm.
                        </p>
                    </div>
                </div>
            </div>
                ...
                {secretary.map((person) => {
                    return (
                        <MemberCard
                            ...
                            name={person.name}
                            post={person.post}
                            url={`assets/${person.name.replaceAll(
                                ' ',
                                '_'
                            )}.jpg`}
                        />
