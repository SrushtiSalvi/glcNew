        ...
        <div className="flex flex-col  justify-end sm:m-3 md:m-8">
          ...
          <div className="text-left sm:text-right font-poppins font-normal text-xs md:text-sm lg:text-lg space-y-3 md:space-y-5 ">
            <p>
              ...
              oldest Law College in Asia, dating even prior to the University
              of Mumbai.
            </p>

            <p>
              Having humbly begun as evening classes in a borrowed premises,
              this college that first lit the candle of legal education in
              India stands tall amongst all its contemporaries.
            </p>
            ...
            <p>
              ...
              like Dr. B. R. Ambedkar, Lokmanya Tilak, Justice M. C. Chagla,
              Sir Motilal Setalvad (first Attorney General of India), and
              several others who have adorned benches of the Supreme Court of
              India and the Bombay High Court and left their footprints behind
              for time immemorial.
            </p>
        ...
        <div className="space-y-8">
          ...
          <div className=" text-justify text-white  font-light  text-xs md:text-sm lg:text-lg ">
            ...
            <p>
              ...
              careers. For the last many years, the Placement Committee has
              been implementing the recruitm ent process throughout the year
              while also organizing two placement weeks in a year. This
              widening scope of the committee benefits both the students and
