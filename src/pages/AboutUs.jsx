    ...
    <>
      ...
      <div className="grid auto-rows-auto grid-cols-1 md:grid-cols-3 place-items-center ">
        <div>
          <img
            src={image_principal}
            className="rounded-full border-black border-2 w-48 h-48 my-8 p-2"
            alt="logo"
          />
      ...
      <div className="grid auto-rows-auto grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 place-items-center gap-y-5 lg:mb-40">
        {people.map((person) => {
          return (
            <MemberCard
              size="sm"
