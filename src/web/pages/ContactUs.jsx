        ...
        <div className="flex lg:flex-row flex-col rounded-sm">
          ...
          <div className="bg-white flex flex-col">
            ...
            <div className="flex content-center">
              <form className="m-8 space-y-20">
                <div className="flex flex-wrap items-center">
                  <div className="md:w-2/5 w-full border-b border-primary-dark mb-8 md:mb-0 pt-12 pb-2 m-2">
                    <input
                  ...
                  <div className="w-full md:w-2/5 border-b border-primary-dark mb-8 md:mb-0 pt-12 pb-2 m-2">
                    <input
                      className="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 px-2 leading-tight focus:outline-none"
                      id="grid-last-name"
                      type="email"
                ...
                <div className="flex items-center  py-2 sm:py-5 m-2">
                  <input
                    className="appearance-none bg-transparent border-b border-primary-dark w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none"
                    type="text"
                    placeholder="Message"
                  />
                </div>
                <button
                  className="flex-shrink-0 bg-primary-light hover:bg-primary-dark border-primary-light hover:border-primary-light text-md text-white py-2 px-5 rounded"
                  type="button"
                >
                  Send
                </button>
