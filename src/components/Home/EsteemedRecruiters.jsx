...
import recruiter1 from "../../assets/logos/ArgusPartners.jpg";
import recruiter2 from "../../assets/logos/AZBPartners.jpg";
import recruiter3 from "../../assets/logos/BharuchaPartners.jpg";
import recruiter4 from "../../assets/logos/CyrilAmarchandMangaldas.png";
import recruiter5 from "../../assets/logos/DSKLegal.jpg";
  ...
  return (
    <section className="mx-4">
      ...
      <div className="flex justify-end w-full">
        <Link to={`/recruiters`}>
          <button className="px-3 py-2 text-sm md:text-md shadow-lg border border-gray-100 mt-5 hover:bg-gray-500 hover:text-white transition-all duration-150 text-black rounded-md">
            Show more
          </button>
        </Link>
      </div>
