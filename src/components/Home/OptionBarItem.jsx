...
const OptionBarItem = ({ title, children }) => {
  return (
    <div className="text-center grid grid-cols-1 gap-1 auto-rows-auto place-items-center shadow-xl bg-white px-4 py-3 rounded-lg md:shadow-none md:rounded-none">
      {children}
